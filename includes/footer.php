<footer class="border-t border-white/5 bg-black py-12 mt-20">
        ...
        <div class="absolute inset-4 md:inset-10 bg-card rounded-2xl overflow-hidden border border-white/10 flex flex-col shadow-2xl">
            <div class="h-14 bg-black border-b border-white/10 flex justify-between items-center px-6">
                ...
                <div class="flex items-center gap-4">
                    <a href="#" class="px-4 py-1.5 bg-accent text-black text-xs font-bold rounded hover:bg-accent-hover transition">Buy Now</a>
    ...
    <script>
        ...
        function openPreview(title, url) {
            ...
            // For demo purpose, if no URL provided, show a placeholder
            ...
            gsap.fromTo(modal.children[1], {scale: 0.9, opacity: 0}, {scale: 1, opacity: 1, duration: 0.3, ease: 'power2.out'});
        }
        ...
        function closePreview() {
            ...
            gsap.to(modal.children[1], {scale: 0.9, opacity: 0, duration: 0.2, onComplete: () => {
